...
void RedRings() {
    ...
    toggleLeftDoinker();
    chassis.moveToPoint(0.35, 50.5, 1500);
    isIntaking = true;
    isSavingRing = true;
    ...
    chassis.turnToPoint(-39.25, 8.25, 1500, {.maxSpeed = TURNSPEED, .minSpeed = 15, .earlyExitRange = 1});
    chassis.waitUntilDone();
    LeftDrive.move(65);
    RightDrive.move(65);
    pros::delay(900);
...
void BlueRings() {
    ...
    chassis.setPose(0, 0, 0);
    toggleRightDoinker();
    chassis.moveToPoint(-0.4, 50.5, 1500);
    isIntaking = true;
    isSavingRing = true;
    chassis.waitUntilDone();
    pros::delay(150);
    ...
    chassis.turnToPoint(-17.5, -0.7, 1500, {.maxSpeed = TURNSPEED, .minSpeed = 15, .earlyExitRange = 1});
    chassis.waitUntilDone();
    toggleIntakeCount();
    chassis.moveToPoint(-17.5, -0.7, 1500, {.maxSpeed = DRIVESPEED});
    chassis.waitUntilDone();
    pros::delay(50);
    toggleIntakeCount();
    pros::delay(20);
...
void AutonomousSkills() {
    ...
    pros::delay(1250);
    isIntaking = false;
    chassis.moveToPoint(-21, -27, 1500, {.maxSpeed = 80});
    chassis.waitUntilDone();
    isIntaking = true;
    chassis.moveToPoint(-44.25, -48.4, 2500, {.maxSpeed = 70, .minSpeed = 20, .earlyExitRange = 0.5});
